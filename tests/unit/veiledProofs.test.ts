...
describe("Generate 'veiled coin' proofs", () => {
  ...
  console.log("aliceVeiledPrivateKey", aliceVeiledPrivateKey.toString());
  console.log("aliceVeiledPrivateKey public", aliceVeiledPrivateKey.publicKey().toString());
  console.log("aliceVeiledPrivateKey public uint8arr", aliceVeiledPrivateKey.publicKey().toUint8Array().toString());
