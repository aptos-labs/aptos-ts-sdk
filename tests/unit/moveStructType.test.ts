...
import { MoveStructType, MoveAbility, MoveFunctionGenericTypeParam, MoveType } from "../../src/types/types";

describe("MoveStructType", () => {
  it("should create a basic Move struct type", () => {
  ...
  it("should create a Move struct type with generic parameters", () => {
  ...
  it("should create a Move struct type with abilities", () => {
  ...
  it("should handle complex struct type with nested fields", () => {
    ...
    expect((complexStruct.fields.rotation_capability_offer as MoveStructType).type).toBe("0x1::account::CapabilityOffer");
    expect((complexStruct.fields.rotation_capability_offer as MoveStructType).fields.for).toBe("address");
  });

  it("should create a Move struct type with all optional properties", () => {
