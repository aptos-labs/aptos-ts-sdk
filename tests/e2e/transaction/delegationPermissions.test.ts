...
describe("transaction submission", () => {
  ...
  let subAccount: AbstractedAccount;
  let subAccount2: AbstractedAccount;
  let receiverAccounts: Ed25519Account[];

  beforeEach(async () => {
    primaryAccount = Account.generate();
    subAccount = AbstractedAccount.fromPermissionedSigner({ signer: primaryAccount });
    subAccount2 = AbstractedAccount.fromPermissionedSigner({ signer: primaryAccount });
...
export async function requestPermission({
  ...
  primaryAccount: Ed25519Account;
  permissionedAccount: AbstractedAccount;
