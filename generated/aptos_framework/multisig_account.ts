...
export namespace MultisigAccount {
  export namespace EntryFunctions {
     ...
     *     arg_0: &signer,
     *     arg_1: u64,
     *     arg_2: vector<0x1::string::String>,
     *     arg_3: vector<vector<u8>>,
     *   )
     **/
     ...
     *     arg_0: &signer,
     *     arg_1: vector<address>,
     *     arg_2: u64,
     *     arg_3: vector<0x1::string::String>,
     *     arg_4: vector<vector<u8>>,
     *   )
     **/
  ...
  export namespace ViewFunctions {
    ...
    export class GetNextTransactionPayload extends ViewFunctionPayloadBuilder {
      ...
      constructor(
        ...
        this.args = {
          multisig_account: AccountAddress.fromRelaxed(multisig_account),
          provided_payload: Hex.fromHexInput(provided_payload),
        };
      }
    }
