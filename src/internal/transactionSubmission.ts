 ...
 * @param args.data - Input data required to generate the transaction payload, which may include bytecode, multisig address, function name, function arguments, type arguments, and ABI.
