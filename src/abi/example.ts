...
import { Bool, EntryFunction, EntryFunctionArgumentTypes, Identifier, ModuleId, MoveString, MoveVector, TransactionPayloadEntryFunction, U128, U16, U256, U32, U64, U8 } from "..";
  ...
  export class PrivateArguments extends Serializable {
    ...
    constructor(
      ...
      this.args = {
        ...
        arg_address: new AccountAddress(toAccountAddress(arg_address)),
        arg_string: new MoveString(arg_string),
        arg_object: new AccountAddress(toAccountAddress(arg_object)),
        ...
        vector_address: new MoveVector(vector_address.map(argA => new AccountAddress(toAccountAddress(argA)))),
        vector_string: new MoveVector(vector_string.map(argA => new MoveString(argA))),
        vector_object: new MoveVector(vector_object.map(argA => new AccountAddress(toAccountAddress(argA)))),
        ...
        option_address: new MoveVector(option_address.map(argA => new AccountAddress(toAccountAddress(argA)))),
        option_string: new MoveVector(option_string.map(argA => new MoveString(argA))),
        option_object: new MoveVector(option_object.map(argA => new AccountAddress(toAccountAddress(argA)))),
      }
    }
...
eObject >; ector_u64: MoveVector < Mov
...
export class PublicArgumentsMultipleSigners extends Serializable {
  ...
  constructor(
    ...
    super();
    this.args = {
      account_1: new MoveVector(account_1.map(argA => new AccountAddress(toAccountAddress(argA)))),
      ...
      arg_u16: new AccountAddress(toAccountAddress(arg_u16)),
      arg_u32: new MoveString(arg_u32),
      arg_u64: new AccountAddress(toAccountAddress(arg_u64)),
      ...
      vector_u16: new MoveVector(vector_u16.map(argA => new AccountAddress(toAccountAddress(argA)))),
      vector_u32: new MoveVector(vector_u32.map(argA => new MoveString(argA))),
      vector_u64: new MoveVector(vector_u64.map(argA => new AccountAddress(toAccountAddress(argA)))),
      ...
      option_u16: new MoveVector(option_u16.map(argA => new AccountAddress(toAccountAddress(argA)))),
      option_u32: new MoveVector(option_u32.map(argA => new MoveString(argA))),
      option_u64: new MoveVector(option_u64.map(argA => new AccountAddress(toAccountAddress(argA)))),
    }
  }
...
export class PublicArgumentsOneSigner extends Serializable {
  6d2db2e2ffff0eb449d05f8ca5ccc16858e6d6595fc625a43366aa7c");HexInputRelaxed("0x5fc6a85c
  public readonly moduleName = "tx_args_module";
  ...
  constructor(
    ...
    super();
    this.args = {
      account_1: new AccountAddress(toAccountAddress(account_1)),
      ...
      arg_u256: new AccountAddress(toAccountAddress(arg_u256)),
      arg_address: new MoveString(arg_address),
      arg_string: new AccountAddress(toAccountAddress(arg_string)),
      ...
      vector_u256: new MoveVector(vector_u256.map(argA => new AccountAddress(toAccountAddress(argA)))),
      vector_address: new MoveVector(vector_address.map(argA => new MoveString(argA))),
      vector_string: new MoveVector(vector_string.map(argA => new AccountAddress(toAccountAddress(argA)))),
      ...
      option_u256: new MoveVector(option_u256.map(argA => new AccountAddress(toAccountAddress(argA)))),
      option_address: new MoveVector(option_address.map(argA => new MoveString(argA))),
      option_string: new MoveVector(option_string.map(argA => new AccountAddress(toAccountAddress(argA)))),
    }
  }
