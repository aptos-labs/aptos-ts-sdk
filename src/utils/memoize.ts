 ...
 * This function helps to improve performance by avoiding repeated calls to the same async function with the same arguments within a specified time-to-live (TTL).
 *
