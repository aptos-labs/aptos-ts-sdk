...
export class Signer {
     ...
     */
    static fromAccount(args: {account: Account, rawTransaction: RawTransaction, secondarySignerAddresses?: Array<AccountAddress>, feePayerAddress?: AccountAddress}): Signer {
     ...
     */
    static async fromWalletProvider(args: { signTransactionFunctionArgs: SignTransactionFunctionArgs, signTransaction: SignTransactionFunction }): Promise<Signer> {
