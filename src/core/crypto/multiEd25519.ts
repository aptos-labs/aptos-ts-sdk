 ...
 */
export class MultiEd25519PublicKey extends Serializable {
  /**
   ...
   */
  public readonly scheme = AuthenticationKeyScheme.MultiEd25519;
 ...
 */
export class MultiEd25519Signature extends Serializable {
  /**
