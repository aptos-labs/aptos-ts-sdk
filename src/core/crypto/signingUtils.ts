...
/**
 * Lightweight signing utilities that don't pull in heavy dependencies.
 * This file is intentionally kept minimal to avoid import chain issues
 * that could drag in keyless/poseidon dependencies (~530KB).
 */
