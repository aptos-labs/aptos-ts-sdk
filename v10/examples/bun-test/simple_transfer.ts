/**
 * v10 Bun runtime test — account generation, funding, transfer
...
const APTOS_NETWORK: Network = (Bun.env.APTOS_NETWORK as Network) || Network.LOCAL;

const example = async () => {
  console.log("v10 Bun Runtime Test: account generation, funding, and transfer");
  console.log(`Bun version: ${Bun.version}, network: ${APTOS_NETWORK}`);
