...
import "dotenv";
import { AccountAddress, Aptos, AptosApiType, Ed25519PrivateKey, PrivateKey, PrivateKeyVariants } from "../@aptos-labs/ts-sdk";
import { LOCAL_ANS_ACCOUNT_PK, LOCAL_ANS_ACCOUNT_ADDRESS } from "@aptos-labs/ts-api/internal/ans";
