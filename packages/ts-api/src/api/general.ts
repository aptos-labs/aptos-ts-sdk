...
import {
  ...
  getProcessorStatus,
  queryIndexer,
} from "@aptos-labs/ts-api/internal/general";
import { getBlockByHeight, getBlockByVersion } from "@aptos-labs/ts-api/internal/transaction";
import { view, viewJson } from "@aptos-labs/ts-api/internal/view";
import {
  AnyNumber,
  Block,
...
import { InputViewFunctionData, InputViewFunctionJsonData } from "@aptos-labs/ts-transactions";
