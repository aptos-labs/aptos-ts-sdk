...
import { AnyNumber, GetObjectDataQueryResponse, OrderByArg, PaginationArgs } from "@aptos-labs/ts-types";
...
import { getObjectDataByObjectAddress } from "@aptos-labs/ts-api/internal/object";
