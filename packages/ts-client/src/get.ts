...
import { AptosResponse, AnyNumber, ClientConfig, MimeType } from "@aptos-labs/ts-types";
import { AptosApiType } from "@aptos-labs/ts-types";
import { registerNetworkClient } from "@aptos-labs/ts-core/network";
import type { GetAptosRequestOptions, AptosConfigLike } from "@aptos-labs/ts-core/network";
 ...
 * @category Client
 */
export type { GetAptosRequestOptions } from "@aptos-labs/ts-core/network";

type GetAptosRequestWithoutType = Omit<GetAptosRequestOptions, "type">;
...
export async function getAptosFullNode<Req extends {}, Res extends {}>(
  options: GetAptosRequestWithoutType,
): Promise<AptosResponse<Req, Res>> {
...
registerNetworkClient({ getAptosFullNode });
