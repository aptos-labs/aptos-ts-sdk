...
/// <reference path="./aptos-client.d.ts" />
...
import { AptosApiType, DEFAULT_MAX_GAS_AMOUNT, DEFAULT_TXN_EXP_SEC_FROM_NOW } from "@aptos-labs/ts-types";
 ...
 * @group Client
 */
export class AptosConfig implements AptosConfigLike {
  /**
