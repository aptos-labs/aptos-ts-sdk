...
import { Bool, FixedBytes, MoveOption, MoveString, MoveVector, U128, U16, U256, U32, U64, U8 } from "@aptos-labs/ts-bcs";
...
import { MoveFunction, MoveModule } from "@aptos-labs/ts-types";
...
export async function fetchModuleAbi(
  ...
  const moduleBytecode = await getTransactionPluginHost().getModule({
    aptosConfig,
