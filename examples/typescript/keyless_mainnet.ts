...
const example = async () => {
  ...
  // Example:
  // Funded 0x3e42a237d4e6a504d1ce00fb12446be69cff8910e9e226e892558c094353c7dd with 0.03 CEDRA and balance was 3,000,000
  ...
  // Transfer to yourself to not waste CEDRA
