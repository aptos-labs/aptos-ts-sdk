...
- Remove `scriptComposer` api due to increase in the sdk bundle size, If you wish to continue using it, please use version 1.38.0: [https://www.npmjs.com/package/@aptos-labs/ts-sdk/v/1.38.0](https://www.npmjs.com/package/@aptos-labs/ts-sdk/v/1.38.0)
