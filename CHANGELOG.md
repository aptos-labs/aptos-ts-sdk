...
- Document the approved Turbo monorepo layout for relocating the TypeScript and confidential-asset SDKs under `packages/` while reserving `packages/payments-sdk` for a future payments SDK.
